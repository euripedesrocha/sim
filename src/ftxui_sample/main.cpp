...
// configuration step. It creates a namespace called `sim`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", sim::cmake::project_name, sim::cmake::project_version) };
